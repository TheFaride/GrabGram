export default function Footer() {
  return (
    <a
      href="https://github.com/TheFaride"
      target="_blank"
      className=" flex items-center border md:rounded-t-lg bg-black px-4 py-3 gap-4"
    >
      <svg
        width="20"
        height="20"
      ...
      <span className=" grow text-white text-xs">Follow me on GitHub</span>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
